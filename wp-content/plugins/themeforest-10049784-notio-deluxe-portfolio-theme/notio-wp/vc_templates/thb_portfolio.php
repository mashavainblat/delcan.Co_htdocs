<?php function thb_portfolio( $atts, $content = null ) {
  ...
  if ( $posts->have_posts() ) {
	...
	<section class="<?php echo implode(' ', $classes); ?>" data-loadmore="#loadmore-<?php echo esc_attr($rand); ?>" data-filter="thb-filter-<?php echo esc_attr($rand); ?>" data-column-width="<?php echo ($style == 'style1' ? esc_attr($columnWidth) : ''); ?>">
